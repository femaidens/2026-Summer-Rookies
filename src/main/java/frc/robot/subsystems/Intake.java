...
public class Intake extends SubsystemBase {
	...
	public Intake() {
		...
		// makes the objects
		rollerMotor = new TalonFX(IntakePorts.ROLLER_MOTOR_PORT);
		PID = new PIDController(Constants.K_P, Constants.K_I, Constants.K_D);
		pivotMotor = new TalonFX(IntakePorts.PIVOT_MOTOR_PORT);
		absoluteEncoder = new DutyCycleEncoder(IntakePorts.ABSOLUTE_ENCODER_PORT);
		// add configs to them
	...
	// idk why anyone'd wanna do manual but this is it (idk how to make it stop when
